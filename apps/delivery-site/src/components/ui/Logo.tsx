...
export default function Logo({
  variant = 'full',
  size = 'md',
  subtitle = 'Experience Delivery Fabric',
  badge = 'EDGE',
  className = '',
}: LogoProps) {
  const sizeMap = {
  ...
  const MarkIcon = (
    ...
    >
      ...
      <div className="relative w-full h-full rounded-xl bg-gradient-to-br from-[#161921] via-[#0f1117] to-[#09090b] border border-white/20 p-[1px] shadow-lg shadow-black/60 flex items-center justify-center">
        ...
        >
          <defs>
            <linearGradient id="cp-del-arc" x1="4" y1="4" x2="32" y2="32" gradientUnits="userSpaceOnUse">
              <stop offset="0%" stopColor="#FFB347" />
              <stop offset="45%" stopColor="#F56E40" />
              <stop offset="100%" stopColor="#E8380D" />
            </linearGradient>
            <linearGradient id="cp-del-core" x1="12" y1="12" x2="26" y2="26" gradientUnits="userSpaceOnUse">
              <stop offset="0%" stopColor="#FFFFFF" />
              <stop offset="100%" stopColor="#F56E40" />
            </linearGradient>
            <filter id="cp-del-glow" x="-20%" y="-20%" width="140%" height="140%">
          ...
          <circle
            ...
            cy="18.5"
            r="3.2"
            fill="url(#cp-del-core)"
            filter="url(#cp-del-glow)"
          />

          {/* Forward Impulse Arrow */}
          <path
